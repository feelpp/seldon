...
namespace Seldon
{
	    ...
	    const T3& omega, int iter, int type_ssor = 2)
  {
    ...
    int* ptr = A.GetPtr();
    int* ind = A.GetInd();
    typename Matrix<T0, Prop0, RowSparse, Allocator0>::pointer data = A.GetData();
    T0 ajj(1);
	   ...
	   const T3& omega,int iter, int type_ssor = 2)
  {
    ...
    Vector<T2, Storage2, Allocator2> Y(ma); Y.Zero();
    T0 ajj(1);
    int p; T0 val(0);
	   ...
	   const T3& omega, int iter, int type_ssor = 2)
  {
    ...
    int* ptr_real = A.GetRealPtr(); int* ptr_imag = A.GetImagPtr();
    int* ind_real = A.GetRealInd(); int* ind_imag = A.GetImagInd();
	   ...
	   const T3& omega, int iter, int type_ssor = 2)
  {
    ...
    Vector<complex<T2>, Storage2, Allocator2> Y(ma); Y.Zero();
    complex<T0> ajj(1);
    int p; complex<T0> val(0);
