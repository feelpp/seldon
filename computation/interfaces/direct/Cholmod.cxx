...
namespace Seldon
{
                  ...
                  bool keep_matrix)
  {
    ...
    // we convert factorisation to column sparse row format
  ...
  //! performs matrix vector product y = L x or y = L^T x
  template<class Transpose_status, class Allocator>
                          ...
                          Vector<double, VectFull, Allocator>& X)
  {
    ...
    Lcsr.SetData(n, n, Lsparse->nzmax, reinterpret_cast<double*>(Lsparse->x),
                 reinterpret_cast<int*>(Lsparse->p), reinterpret_cast<int*>(Lsparse->i));
